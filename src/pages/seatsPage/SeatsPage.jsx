...
const SeatsPage = () => {
  ...
  const getSeatsData = async () => {
    ...
    if (data?.status) {
      const bookedSeatsDetails = data?.show?.tickets;

      let bookedBalconySeats;
      let bookedMiddleSeats;
      let bookedLowerSeats;
      if (bookedSeatsDetails?.balcony) {
        bookedBalconySeats = Object.keys(bookedSeatsDetails?.balcony);
      }
      if (bookedSeatsDetails?.middle) {
        bookedMiddleSeats = Object.keys(bookedSeatsDetails?.middle);
      }
      if (bookedSeatsDetails?.lower) {
        bookedLowerSeats = Object.keys(bookedSeatsDetails?.lower);
      }
